...
EXPERIMENT_CONDA_ENV_BASE="${EXPERIMENT_CONDA_ENV_BASE:-rvs-experiment-base-deps}" ./experiment.sh "$EXPERIMENT_REPOSITORY" "$EXPERIMENT_REPOSITORY_PROJECT_PATH" "$experiment_name" "$experiment_dir" ervs "$@" --output-dir "$eval_output_dir"
