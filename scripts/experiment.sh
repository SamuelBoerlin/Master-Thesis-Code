...
EXPERIMENT_REPOSITORY="https://github.com/SamuelBoerlin/Master-Thesis-Code.git"
EXPERIMENT_REPOSITORY_PROJECT_PATH="."

EXPERIMENT_CONDA_ENV_BASE="experiment-base-deps"
EXPERIMENT_CONDA_ENV_PREFIX="experiment_"
EXPERIMENT_CONDA_ENV_SETUP_SCRIPT="env_setup.sh"

EXPERIMENT_TMUX_SESSION_PREFIX="experiment_"
